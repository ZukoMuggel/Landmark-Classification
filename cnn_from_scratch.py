...
data_loaders = get_data_loaders(5,0.01,-1,-1)#  YOUR CODE HERE
...
# 
# - convolutional layer changes the image to 16 depth
# - pooling to extract the information
# - another convolutional layer increase number of feature maps to 32 
# - pooling again
# - Flatten 
# - create a hidden layer 
# - dropout
# - add the output layer,The number of outputs should match the actual classes
...
# First let's get the class names from our data loaders  BN
